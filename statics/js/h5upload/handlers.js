function att_show(serverData,file)
{
	...
	if(ext == 1) {
		var img = '<span class="checkbox"></span><input type="checkbox" class="checkboxes" name="ids[]" value="'+id+'" /><a href="javascript:;" onclick="javascript:att_cancel(this,'+id+',\'upload\')" class="on"><div class="icon"></div><img src="'+src+'" width="80" height="150" imgid="'+id+'" path="'+src+'" title="'+filename+'"/><i class="size"></i><i class="name" title="'+filename+'">'+filename+'</i></a>';
	} else {
	...
	$('#fsUpload').append('<div id="attachment_'+id+'" class="files_row on"></div>');
