		...
		if ($sitelist[$siteid]['mobile_domain']) {
			if ($ishtml==1) {
				...
				//if (defined('IS_MOBILE') && IS_MOBILE) {
					return $sitelist[$siteid]['mobile_domain'].'index.php?m=content&c=index&a=lists&catid='.$catid;
				//} else {
					//return APP_PATH.'index.php?m=content&c=index&a=lists&catid='.$catid;
				//}
			}
		} else {
			if ($ishtml==1) {
	...
	if ($sitelist[$siteid]['mobilehtml']==1) {
		if ($sitelist[$siteid]['mobile_domain']) {
			if ($content_ishtml==1) {
				...
				//if (defined('IS_MOBILE') && IS_MOBILE) {
					return $sitelist[$siteid]['mobile_domain'].'index.php?m=content&c=index&a=show&catid='.$catid.'&id='.$id;
				//} else {
					//return APP_PATH.'index.php?m=content&c=index&a=show&catid='.$catid.'&id='.$id;
				//}
			}
		} else {
			if ($content_ishtml==1) {
