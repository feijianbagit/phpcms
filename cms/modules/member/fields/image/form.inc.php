	function image($field, $value, $fieldinfo) {
		...
		$authkey = upload_key("1,$upload_allowext,$isselectimage,$images_width,$images_height,,$image_reduce");
		if($show_type) {
			...
			<a href='javascript:;' onclick=\"javascript:flashupload('{$field}_images', '".L('attachment_upload')."','{$field}',thumb_images,'1,$upload_allowext,$isselectimage,$images_width,$images_height,,$image_reduce','member','','{$authkey}')\">
