                ...
                <table width="100%" cellspacing="0">
                    ...
                    <tr class="odd gradeX" id="dr_row_<?php echo $t['aid'];?>">
                        ...
                        <td>
                            ...
                            <a class="btn green btn-xs" href="javascript:iframe_show('<?php echo L('重新上传');?>', '?m=attachment&c=manage&a=public_file_edit&aid=<?php echo $t['aid'];?>', '350px', '220px');"><?php echo L('重传');?></a>
