...
<div class="files" id="fsUploadProgress">
<?php foreach($infos as $r) {?>
	<div class="files_row">
		<span class="checkbox"></span>
		<input type="checkbox" class="checkboxes" name="ids[]" value="<?php echo $r['aid']?>" />
		<a><img src="<?php echo $r['src']?>" id="<?php echo $r['aid']?>" width="<?php echo $r['width']?>" path="<?php echo $this->upload_url.$r['filepath']?>" title="<?php echo $r['filename']?>" size="<?php echo $this->attachment->size($r['filesize'])?>"/></a>
		<i class="size"> <?php echo $this->attachment->size($r['filesize'])?> </i>
