...
class index {
	...
	public function init() {
		...
		if (pc_base::_is_mobile($siteid) && $sitelist[$siteid]['mobileauto'] || defined('IS_MOBILE') && IS_MOBILE) {
			if (!file_exists(PC_PATH.'templates'.DIRECTORY_SEPARATOR.$style.DIRECTORY_SEPARATOR.'mobile'.DIRECTORY_SEPARATOR.'index.html')) {
