        ...
        <div class="form-body">
            <form id="myform_category_show">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <label><select class="bs-select form-control"<?php if (dr_count($categorys) > 30) {echo 'data-live-search="true"';}?> name='catids[]' id='catids' multiple="multiple" style="width:350px;height:260px;" title="<?php echo L('no_limit_category');?>">
