                ...
                <div class="table-list">
                    <table style="margin-top: 30px;" class="table table-striped table-bordered table-hover table-checkable dataTable">
                        ...
                        <tr class="heading">
                            ...
                            <td>
                                <label><button type="button" onclick="iframe_show('<?php echo L('批量操作')?>', '?m=content&c=create_html&a=public_show_url&modelid=<?php echo $_v['modelid'];?>')" class="btn blue btn-xs"> <i class="fa fa-refresh"></i> <?php echo L('批量更新内容URL地址')?> </button></label>
