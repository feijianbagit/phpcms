...
<form name="myform" id="myform" action="?m=content&c=content&a=edit" onsubmit="return checkall()" method="post" enctype="multipart/form-data">
...
<input value="<?php echo L('c_close');?>" type="button" name="close" id="close" onclick="close_window();" class="dialog" title="Alt+X">
</form>
