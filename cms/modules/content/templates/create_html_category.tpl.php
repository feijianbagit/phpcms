...
<th align="center"><?php echo L('select_operate_content');?></th>
    ...
    <tbody height="200" class="nHover td-line">
		...
		?></td>
            <td rowspan="2" colspan="1"><select name='catids[]' id='catids' multiple="multiple" style="height:200px;width:366px;" title="<?php echo L('push_ctrl_to_select');?>">
