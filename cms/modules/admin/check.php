...
\'tpl_referesh\' => '.((int)pc_base::load_config('system','tpl_referesh') ? (int)pc_base::load_config('system','tpl_referesh') : 1).',
...
\'attachment_del\' => \''.((int)pc_base::load_config('system','attachment_del') ? (int)pc_base::load_config('system','attachment_del') : 1).'\', //是否同步删除附件 0 否 1 是
...
\'debug\' => '.((int)pc_base::load_config('system','debug') ? (int)pc_base::load_config('system','debug') : 1).', //是否显示调试信息
...
\'needcheckcomeurl\' => \''.((int)pc_base::load_config('system','needcheckcomeurl') ? (int)pc_base::load_config('system','needcheckcomeurl') : 1).'\', //是否需要检查外部访问，1为启用，0为禁用
\'admin_log\' => '.((int)pc_base::load_config('system','admin_log') ? (int)pc_base::load_config('system','admin_log') : 1).', //是否记录后台操作日志
\'gzip\' => '.((int)pc_base::load_config('system','gzip') ? (int)pc_base::load_config('system','gzip') : 1).', //是否Gzip压缩后输出
