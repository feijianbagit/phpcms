...
<div class="showMsg" style="text-align:center">
	...
	<?php if ($dialog):?><script style="text/javascript">$(function(){if(window.top.right != this.window){window.top.right.location.reload();}if(window.top.art.dialog({id:"<?php echo $dialog?>"})){window.top.art.dialog({id:"<?php echo $dialog?>"}).close();}else{ownerDialog.close();}})</script><?php endif;?>
        </div>
</div>
<script style="text/javascript">
	function close_dialog() {
		if(window.top.right != this.window){window.top.right.location.reload();}if(window.top.art.dialog({id:"<?php echo $dialog?>"})){window.top.art.dialog({id:"<?php echo $dialog?>"}).close();}else{ownerDialog.close();}
	}
</script>
