...
<div class="col-2 col-auto">
	...
	<?php echo L('running_version')?>Cms <?php echo CMS_VERSION?> [<?php echo CMS_RELEASE?>]<br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<?php echo L('main_download')?><a href="https://code.phpcmsx.com/zhaoxunzhiyin/" target="_blank">有意思代码仓库</a><br>
