...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="mobilehtml" value="1"> <?php echo L('yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="mobilehtml" value="0" checked> <?php echo L('no');?> <span></span></label><br><?php echo L('html_mobile_desc')?>
      </div>
    </td>
  </tr>
  <tr>
