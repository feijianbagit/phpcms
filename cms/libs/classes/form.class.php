...
$.ajax({
    type: 'POST',
    url: '".SELF."?m=attachment&c=attachments&a=down_img&module=".$module."&catid=".$catid."&args=".$p."&authkey=".$authkey."&token=".csrf_hash()."',
    dataType: 'json',
...
$.ajax({
	...
	public static function select_category($file = '',$catid = 0, $str = '', $default_option = '', $modelid = 0, $type = -1, $onlysub = 0,$siteid = 0,$is_push = 0) {
		...
		if (!$file) {
			$file = 'module/category-'.$siteid.'-data';
		}
		$result = getcache('cache', $file);
