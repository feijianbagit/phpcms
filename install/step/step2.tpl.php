    ...
    <div class="body_box">
     ...
     <table cellpadding="0" cellspacing="0" class="table_list">
                  ...
                  <tr>
                    ...
                    <td>PHP 5.2.0 及以上</td>
                    <td><?php if(phpversion() >= '5.2.0'){ ?><span><img src="images/correct.png" /></span><?php }else{ ?><font class="red"><img src="images/error.png" />&nbsp;无法安装</font><?php }?></font></td>
                  </tr>
                  <tr>
                    <td>MYSQLI 扩展</td>
            ...
            <a onClick="Dialog.alert('当前配置不满足CMS安装需求，无法继续安装！');" class="x_btn pre">检测不通过</a>
             <?php }?>
            <form id="install" action="<?php echo SELF;?>" method="get">
